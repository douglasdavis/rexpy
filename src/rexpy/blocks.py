...
def top_blocks(**kwargs):
    params = dict(
        ...
        fit="tW",
        label="tW Dilepton",
        ntuplepaths=c.ntuple_directory(),
        dotables="FALSE",
        systplots="FALSE",
        reg1j1b_selection=c.r1j1b_selection(),
        reg1j1b_variable=c.DEF_1j1b_var,
        reg1j1b_binning=c.r1j1b_bins(),
        reg2j1b_selection=c.r2j1b_selection(),
        reg2j1b_variable=c.DEF_2j1b_var,
        reg2j1b_binning=c.r2j1b_bins(),
        reg2j2b_selection=c.r2j2b_selection(),
